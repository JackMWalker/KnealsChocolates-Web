...
include "inc/edit_calendar_script.php";
?>
<!DOCTYPE html>
<html lang="en-us">
...
<div id="title-container">
	...
	<div id="content">
		<div id="product-list"><a class="logout" href="inc/logout.php">Log out</a>
			<a class="cancel-button" href="manage_calendar.php#inventoryForm">Cancel and Add New Event</a><br/>
		</div>
		<div id="add-new-product-form">
		<a name="inventoryForm" id="inventoryForm"></a>
			<h2>Add New Item Form</h2>
			<form onsubmit="return submit_calendar_form();" action="edit_calendar.php" name="myForm" id="myForm" method="post">
			<table width="80%" border="0" cellspacing="0" cellpadding="5">
				<tr>
					<td width="15%">Event Title</td>
					<td width="85%"><input type="text" name="event_title" id="event_title" value="<?php echo $eventTitle; ?>" size="60"/><span class="required">*</span>
					<span class="hidden" id="title_error">This field is required.</span></td>
				</tr>
				<tr>
					<td width="15%">Description</td>
					<td width="85%"><textarea name="event_desc" id="event_desc" rows="5" cols="60"><?php echo $eventDesc; ?></textarea><span class="required">*</span>
					<span class="hidden" id="desc_error">This field is required.</span></td>
				</tr>
				<tr>
					<td width="15%">Event Address</td>
					<td width="85%"><textarea name="event_address" id="event_address" rows="5" cols="60"><?php echo $eventAddress; ?></textarea><span class="required">*</span>
					<span class="hidden" id="address_error">This field is required.</span></td>
				</tr>
				<tr>
					<td width="15%">Event Date</td>
					<td width="85%"><input type="text" name="event_date" id="event_date" value="<?php echo $formatDate; ?>" placeholder="dd/mm/yyyy"size="12"/><span>Use Leading 0's and forward slashes eg. 01/05/2013</span><span class="required">*</span>
					<span class="hidden" id="date_error">This field is required.</span></td>
				</tr>
				<tr>
					<td width="15%">Event URL</td>
					<td width="85%"><input type="text" name="event_url" value="<?php echo $eventURL; ?>" id="event_url" size="60"/></td>
				</tr>
				<tr>
					<td width="15%">Event Times</td>
					<td width="85%"><input type="text" name="event_times" value="<?php echo $eventTimes; ?>" id="event_times" size="60"/></td>
				</tr>
				<tr>
					<td width="15%">&nbsp;</td>
					<td width="85%"><input name="thisID" type="hidden" value="<?php echo $targetID; ?>" />
					<input type="submit" name="button" id="button" value="Update event"/></td>
				</tr>
			</table>	
			</form>
		</div>
