...
<div id="title-container">
	...
	<div id="content">
		<div id="product-list"><a class="logout" href="inc/logout.php">Log out</a>
			<h2>Seasonal Chocolates in Store</h2><a class="add-new-button" href="manage_<?php echo $category;?>.php#inventoryForm">+ Add New Item</a><br/>
		...
		<a name="inventoryForm" id="inventoryForm"></a>
			...
			<table width="80%" border="0" cellspacing="0" cellpadding="5">
				...
				<tr>
					...
					<td width="85%"><input type="text" name="weight" id="weight" size="12"/><span> grams</span><span class="required">*</span>
