...
<div id="title-container">
	...
	<div id="content">
		<div id="product-list"><a class="logout" href="inc/logout.php">Log out</a>
			<h2>Luxury Chocolates in Store</h2><a class="add-new-button" href="manage_<?php echo $category;?>.php#inventoryForm">+ Add New Item</a><br/>
		...
		<a name="inventoryForm" id="inventoryForm"></a>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="5">
				<tr>
					<td >Product Title</td>
					<td ><input type="text" name="ptitle" id="ptitle" size="40"/><span class="required">*</span>
					<td ></td>
					<span class="hidden" id="title_error">This field is required.</span></td>
				</tr>
				<tr>
					<td>Product Price</td>
					<td><input type="text" name="pprice" id="pprice" size="12"/><span class="required">*</span>
				...
				<tr>
					<td >Weight</td>
					<td ><input type="text" name="weight" id="weight" size="12"/><span> grams</span><span class="required">*</span>
					<span class="hidden" id="weight_error">This field is required.</span></td>
				</tr>
				<tr>
					<td >Allergy Info</td>
					<td ><input type="text" name="allergy" id="allergy" size="40"/><span class="required">*</span>
					<span class="hidden" id="allergy_error">This field is required.</span></td>
				</tr>
				<tr>
					<td >Description</td>
					<td ><textarea name="description" id="description" rows="5" cols="40"></textarea><span class="required">*</span>
					<span class="hidden" id="desc_error">This field is required.</span></td>
				</tr>
				<tr>
					<td >Paypal Url</td>
					<td ><textarea name="paypalurl" id="paypalurl" rows="5" cols="40"></textarea></td>
				</tr>
				<tr>
					<td >Postage Cost</td>
					<td ><input type="text" name="postage" id="postage" size="12"/></td>
				</tr>
				<tr>
					<td >Product Image</td>
					<td ><input type="file" name="fileField" id="fileField"/><span class="required">*</span>
